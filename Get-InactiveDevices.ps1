...
.PARAMETER 
    Get-ADComputer -Server DC01-SearchBase OU=Computers
...
$csvFilePath = "C:\Admins\InactiveDevices\InactiveDevices.csv"
...
Write-Host "Inactive devices exported to '$csvFilePath'."
