...
.OUTPUTS
    CSV file saved to: C:\MailboxUsage.csv
...
.EXAMPLE
    ...
    This will:
        ...
        - Read email addresses from C:\users.txt
        - Query mailbox statistics for each user
        - Save results to C:\MailboxUsage.csv
#>
...
$inputFile  = "C:\users.txt"   # Path to your text file with user emails
$outputFile = "C:\MailboxUsage.csv"  # Path to output CSV file
...
Write-Host "Mailbox usage data has been exported to $outputFile"
